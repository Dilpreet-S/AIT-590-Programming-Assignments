##############################################################################################################
# Anugh Shrestha, Gauthami, Dilpreet Singh Bedi
# Date- 
# Team -
##############################################################################################################
##### INTRODUCTION ####
...
#The list values represents the list of responses to the matching pattern of words and sentences in the input of the user
#When the pattern of words or responses matches a key, it will randomly pull a response from the corresponding list value
...
def generate_response(user_response):
	...
	if valid_status == "valid":
		...
		for pattern, reponse in possible_responses.items():
			...
			#if there is a match, a random response is choosen from the list
			if match:
